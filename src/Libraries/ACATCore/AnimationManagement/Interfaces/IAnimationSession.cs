...
// AnimationManager per-panel pattern for new callers.
//
////////////////////////////////////////////////////////////////////////////
...
namespace ACAT.Core.AnimationManagement.Interfaces
{
    ...
    public interface IAnimationSession : IDisposable
    {
        ...
        /// Transitions to Running state. No-op if already Running.
        /// </summary>
        ...
        /// <summary>
        /// Sets the selected/active widget by name. Used by manual and step scan modes
