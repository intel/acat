...
namespace ACAT.Extensions.BCI.Common
{
    ...
    /// </summary>
    [Serializable]
    public class BCIActuatorSettings : PreferencesBase
    {
        /// <summary>
        ...
        /// </summary>
        public BCIActuatorSettings Load(bool saveAfterLoad = true)
        {
            BCIActuatorSettings retVal = PreferencesBase.Load<BCIActuatorSettings>(SettingsFilePath, true, saveAfterLoad);
            return retVal;
        }
