...
namespace ACAT.Extensions.BCI.Sensors.GTecSensor
{
    ...
    /// </summary>
    public partial class UserControlErrorBluetoothDisconnected : UserControlBCIBase
    {
        ...
        private void ListViewPairedDevices_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                _gTecBCI.BCIGtecActuatorSettings.GTecDeviceName = selectedDevice;
                _gTecBCI.BCIGtecActuatorSettings.Save();
                Log.Debug("Saved BCIGtecActuatorSettings.Settings.GTecDeviceName to ACAT settings: " + _gTecBCI.BCIGtecActuatorSettings.GTecDeviceName);
            }
        }
