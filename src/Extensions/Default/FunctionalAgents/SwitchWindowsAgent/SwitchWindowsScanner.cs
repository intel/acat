...
namespace ACAT.Extensions.FunctionalAgents.SwitchWindowsAgent
{
    ...
    /// </summary>
    [ClassDescriptorAttribute("52D33D6A-4254-4727-8291-DC9D26A51F4F",
    ...
    public partial class SwitchWindowsScanner : GenericScannerForm
    {
        ...
        /// </summary>
        private ExtensionInvoker _invoker { get; set; }
        ...
        private List<EnumWindows.WindowInfo> getWindowList(SortOrder order)
        {
            ...
            if (String.IsNullOrEmpty(processName))
            {
                ...
                if (desktopHWnd != null)
                {
                    sortedList.Insert(0, new EnumWindows.WindowInfo(desktopHWnd, StringResources.ShowDesktop));
                }
            }
        ...
        private void handleWindowSelect(EnumWindows.WindowInfo wInfo)
        {
            ...
            {
                DialogUtils.Toast(StringResources.WindowNotFound);
            }
        ...
        private void refreshWindowList()
        {
            ...
            if (!_windowsList.Any())
            {
                ...
                list[0].SetText(StringResources.NoActiveWindows);
                return;
            }
        ...
        private void updateButtonBar()
        {
            ...
            {
                var str = String.Format(StringResources.PageNofM, (_pageNumber + 1), _numPages);
        ...
        private void updateStatusBar()
        {
            ...
            {
                case SortOrder.Ascending:
                    text = StringResources.SortOrderAlphabetical;
                    break;

                case SortOrder.Descending:
                    text = StringResources.SortOrderReverseAlphabetical;
                    break;
            }
