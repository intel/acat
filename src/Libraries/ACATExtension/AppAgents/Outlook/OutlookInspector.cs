...
namespace ACAT.Extension.AppAgents.Outlook
{
    ...
    /// </summary>
    internal class OutlookInspector : IOutlookInspector
    {
        /// <summary>
        ...
        public bool IsAddressBookWindow(WindowActivityMonitorInfo monitorInfo, ref OutlookControlSubType subType)
        {
            ...
            if (retVal)
            {
                if (AgentUtils.IsElementByAutomationId(monitorInfo.FocusedElement, "RichEdit20WPT", "ControlType.Edit", "101"))
                {
        ...
        {
            return (monitorInfo.Title.ToLower().StartsWith("TODO") &&
                        monitorInfo.Title.ToLower().EndsWith("TODO"));
        }
