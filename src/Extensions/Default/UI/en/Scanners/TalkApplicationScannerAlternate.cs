////////////////////////////////////////////////////////////////////////////
// <copyright file="TalkApplicationScannerAlternate.cs" company="Intel Corporation">
//
...
namespace ACAT.Extensions.Default.UI.Scanners
{
    ...
    /// layout is optimized for typing  Letters are arranged so the most
    /// frequently used letters in the language are at the beginning of each
    /// row
    /// </summary>
    [DescriptorAttribute("44DD722B-2BA2-42F4-9AE6-B13108A6F025",
                        "TalkApplicationScannerAlphabetical",
                        "Talk application window with Alternate keyboard layout")]
    public partial class TalkApplicationScannerAlternate : Form, IScannerPanel, ISupportsStatusBar, IScannerPreview
    {
        /// <summary>
        /// Number of phrases to display in the phrase list
        /// </summary>
        private const int PhraseCount = 9;

        /// <summary>
        /// Number of preferred words in the word list
        /// </summary>
        private const int PreferredWordListCount = 9;
        ...
        /// List of phrases
        /// </summary>
        private List<Phrase> _phraseList;
        ...
        /// </summary>
        public TalkApplicationScannerAlternate()
        {
        ...
        /// <summary>
        /// Gets or sets the preview mode. This enables zoom in/out
        /// operations on the scanner so the user can choose a
        /// preferred size for the
        /// </summary>
        ...
        /// <summary>
        /// Loads favorite phrases from the phrases list.
        /// </summary>
        ...
        /// Set the form style
        /// </summary>
        /// <param name="createParams">form create params</param>
        ...
        private class CommandHandler : RunCommandHandler
        {
            ...
            public override bool Execute(ref bool handled)
            {
                ...
                var form = Dispatcher.Scanner.Form as TalkApplicationScannerAlternate;
                ...
                switch (Command)
                {
                    ...
                    case "CmdCursorScanner":
                        form.createAndShowScanner(PanelClasses.Cursor, form);
                        break;
