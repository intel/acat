...
namespace ACAT.Extensions.BCI.Actuators.EEG.EEGProcessing
{
    ...
    public class DataParser
    {
        ...
        public void ParseDataFromBrainflow(double[,] allData, out double[,] rawData, out int[] triggerData, out int numTriggerPulses)
        {
            ...
            rawData = new double[OpenBCISensorSettings.Settings.DAQ_NumEEGChannels, numSamples];
            ...
            {
                if (OpenBCISensorSettings.Settings.DataParser_UseSoftwareTrigers)
                {
                ...
                // rawData
                _ = new double[OpenBCISensorSettings.Settings.DAQ_NumEEGChannels];
                for (int ch = 0; ch < OpenBCISensorSettings.Settings.DAQ_NumEEGChannels; ch++)
                {
