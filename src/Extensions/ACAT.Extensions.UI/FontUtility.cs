...
{
    public static class BootstrapFontUtility
    {
        /// <summary>
        /// Gets the list of bootstrap font characters for the specified font name.
        /// </summary>
        /// <param name="fontName">The name of the font.</param>
        /// <returns>A string representing the bootstrap font character.</returns>
        public static string GetBootstrapFontCharacter(string character)
        {
            if (BootStrapFontCharaters.TryGetValue(character, out int codePoint))
            {
                return char.ConvertFromUtf32(codePoint);
            }
            else
            {
                throw new ArgumentException($"Character '{character}' not found in Bootstrap font characters.");
            }
        }
