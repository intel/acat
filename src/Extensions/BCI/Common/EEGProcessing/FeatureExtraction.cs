...
namespace ACAT.Extensions.BCI.Actuators.EEG.EEGProcessing
{
    ...
    public class FeatureExtraction
    {
        ...
        public FeatureExtraction(Dictionary<int, int[]> pSymbolsInGroups, CalibrationParametersForSection pCalibrationParameters, int numRows = 6, int numCols = 6, bool isRowCol = true)
        {
            ...
            offsetTarget = OpenBCISensorSettings.Settings.Calibration_OffsetTarget;
            windowDuration = OpenBCISensorSettings.Settings.FeatureExtraction_WindowDurationInMs / 1000f;
            sampleRate = BCISettingsFixed.DAQ_SampleRate;
            displayPlots = OpenBCISensorSettings.Settings.Calibration_DisplaySignalsAfterCalibrationFlag;
            eyesClosed_stdMultiplier = OpenBCISensorSettings.Settings.EyesClosed_AdaptiveThreshold_StandardDeviationMultiplier;
            ...
            bool[] channelSubsetEnabled = new bool[]
                                            { OpenBCISensorSettings.Settings.Classifier_EnableChannel1,
                                                OpenBCISensorSettings.Settings.Classifier_EnableChannel2,
                                                OpenBCISensorSettings.Settings.Classifier_EnableChannel3,
                                                OpenBCISensorSettings.Settings.Classifier_EnableChannel4,
                                                OpenBCISensorSettings.Settings.Classifier_EnableChannel5,
                                                OpenBCISensorSettings.Settings.Classifier_EnableChannel6,
                                                OpenBCISensorSettings.Settings.Classifier_EnableChannel7,
                                                OpenBCISensorSettings.Settings.Classifier_EnableChannel8,
                                                OpenBCISensorSettings.Settings.Classifier_EnableChannel9,
                                                OpenBCISensorSettings.Settings.Classifier_EnableChannel10,
                                                OpenBCISensorSettings.Settings.Classifier_EnableChannel11,
                                                OpenBCISensorSettings.Settings.Classifier_EnableChannel12,
                                                OpenBCISensorSettings.Settings.Classifier_EnableChannel13,
                                                OpenBCISensorSettings.Settings.Classifier_EnableChannel14,
                                                OpenBCISensorSettings.Settings.Classifier_EnableChannel15,
                                                OpenBCISensorSettings.Settings.Classifier_EnableChannel16
                                            };
            ...
            // DataParser
            _DataParserObj = new DataParser(BCISettingsFixed.DAQ_SampleRate, OpenBCISensorSettings.Settings.FeatureExtraction_WindowDurationInMs, OpenBCISensorSettings.Settings.Calibration_OffsetTarget, _symbolsInGroups);
            ...
            _DimReductPCAObj = new DimReductPCA(OpenBCISensorSettings.Settings.DimReductPCA_ComponentSortMethod, OpenBCISensorSettings.Settings.DimReductPCA_MinEigenvalue);

            // RDA
            _DimReductRDAObj = new DimReductRDA(OpenBCISensorSettings.Settings.DimReductRDA_ShrinkParam, OpenBCISensorSettings.Settings.DimReductRDA_RegParam);
            ...
            // Crossvalidation
            _CrossValidationObj = new KFoldCrossValidate(OpenBCISensorSettings.Settings.CrossValidation_NumFolds, OpenBCISensorSettings.Settings.CrossaValidation_SortMethod);
            ...
            if (pCalibrationParameters != null)
            {
                ...
                trainedClassifiersFileID = OpenBCISensorSettings.Settings.Calibration_TrainedClassifiersFilePath + "_" + calibrationParameters.CalibrationMode.ToString();
            }
            else
            {
                trainedClassifiersFileID = OpenBCISensorSettings.Settings.Calibration_TrainedClassifiersFilePath;
                minAUCRequired = 0;
            }
