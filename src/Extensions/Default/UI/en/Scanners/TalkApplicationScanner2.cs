...
{
    [DescriptorAttribute("8AF2949C-19E7-42F4-B31F-2D216859AEF3",
                        "TalkApplicationScanner",
                        "Talk application main window")]
    public partial class TalkApplicationScanner2 : Form, IScannerPanel, ISupportsStatusBar
    {
        ...
        /// </summary>
        public TalkApplicationScanner2()
        {
        ...
        private class CommandHandler : RunCommandHandler
        {
            ...
            public override bool Execute(ref bool handled)
            {
                ...
                var form = Dispatcher.Scanner.Form as TalkApplicationScanner2;
