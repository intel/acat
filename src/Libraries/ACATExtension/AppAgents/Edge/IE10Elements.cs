////////////////////////////////////////////////////////////////////////////
// <copyright file="IE10Elements.cs" company="Intel Corporation">
//
...
namespace ACAT.Extension.AppAgents.InternetExplorer
{
    /// <summary>
    /// Determines which control in the IE Browser currently has focus
    /// E.g.  Is it the address bar?  Is it the Find window?
    /// This is applicable only to IE10
    /// </summary>
    public class IE10Elements : IInternetExplorerElements
    {
        /// <summary>
        ...
        public void EmailPageAsLink()
        {
            ...
            Thread.Sleep(750);
            AgentManager.Instance.Keyboard.Send(Keys.E);
            Thread.Sleep(500);
