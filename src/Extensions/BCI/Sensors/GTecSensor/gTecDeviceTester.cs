...
namespace ACAT.Extensions.BCI.Sensors.GTecSensor
{
    ...
    {
        public DAQ_gTecBCI gTecBCI = new DAQ_gTecBCI();
        ...
        public GTecDeviceTester()
        {
            ...
            try
            {
                _Testing_useSensor = gTecBCI.BCIGtecActuatorSettings.Testing_UseSensor;
            }
            catch (Exception ex)
            {
                Log.Exception(ex);
            ...
            switch (bluetoothEvent)
            {
                ...
                case DAQ_gTecBCI.BluetoothEvent.SUCCESSFUL_CONNECTION:
                    ...
                    if (_currentOnboardingUserState == OnboardingUserState.Testing_BCIConnections || _currentOnboardingUserState == OnboardingUserState.ErrorBluetoothDisconnected)
                    {
                        ...
                        {
                            gTecBCI.Start(gTecBCI.BCIGtecActuatorSettings.GTecDeviceName);
                        });
                        thread.Start();
                        thread.Join();
            ...
            switch (buttonNextName)
            {
                ...
                case "buttonNext_userControlBCISignalCheckStartPrompt": 
                    ...
                    if (!userRequestedRecheck)
                    {
                        ...
                        gTecBCI.BCIGtecActuatorSettings.SignalControl_RecheckNeeded = false;
                        gTecBCI.BCIGtecActuatorSettings.Save();
                    ...
                    {
                        // Save SignalQuality_RecheckNeeded
                        gTecBCI.BCIGtecActuatorSettings.SignalControl_RecheckNeeded = true;
                        gTecBCI.BCIGtecActuatorSettings.Save();
                ...
                case "buttonNext_userControlPromptBCIFIlterSettings":
                    ...
                    if (_mainForm._userControlPromptBCIFIlterSettings.checkBoxConfirm60HzCountry.Checked)
                    {
                        ...
                        gTecBCI.BCIGtecActuatorSettings.DAQ_NotchFilterIdx = 2;
                    }
                    else
                    {
                        gTecBCI.BCIGtecActuatorSettings.DAQ_NotchFilterIdx = 1;
                    }

                    if (_mainForm._userControlPromptBCIFIlterSettings.checkBoxDontShowStartup.Checked)
                    {
                        gTecBCI.BCIGtecActuatorSettings.DAQ_ShowFilterSettings = false;
                    }
                    else
                    {
                        gTecBCI.BCIGtecActuatorSettings.DAQ_ShowFilterSettings = true;
                    }
                ...
                case "buttonNext_userControlBCISignalCheck":
                    ...
                    bool userPassedLastSignalQualityCheck = gTecBCI.BCIGtecActuatorSettings.SignalQuality_PassedLastOverallQualityCheck;
                    ...
                    if (gTecBCI.BCIGtecActuatorSettings.Testing_IgnoreSignalTestResultDuringOnboarding)
                    {
                    ...
                    int chnIdx = 0;
                    while (chnIdx < gTecBCI.BCIGtecActuatorSettings.DAQ_NumEEGChannels)
                    {
                        channelNames[chnIdx] = UserControlBCISignalCheck._eegChannels[chnIdx]._electrodeName;
                        enabledChannels[chnIdx] = gTecBCI.BCIGtecActuatorSettings.GetClassifier_EnableChannel(chnIdx);
                    ...
                    if (exitBCIOnboarding)
                    {
                        ...
                        gTecBCI.BCIGtecActuatorSettings.Save(); // Save settings
        ...
        private void runSignalCheckIfRequired()
        {
            ...
            long timestampPrevImpedanceTest = gTecBCI.BCIGtecActuatorSettings.SignalQuality_TimeOfLastImpedanceCheck;
            ...
            double maxTimeMins = (double)gTecBCI.BCIGtecActuatorSettings.SignalQuality_MaxTimeMinsElapsedSinceLastImpedanceCheck​;
