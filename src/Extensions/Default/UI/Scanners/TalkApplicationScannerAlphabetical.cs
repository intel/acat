////////////////////////////////////////////////////////////////////////////
// <copyright file="TalkApplicationScannerAlphabetical.cs" company="Intel Corporation">
//
...
namespace ACAT.Extensions.Default.UI.Scanners
{
    ...
    /// layout is alphabetical
    /// </summary>
    [DescriptorAttribute("86B57FA0-2EF3-4C07-81E7-6796AE9B7B59",
                        "TalkApplicationScannerAlphabetical",
                        "Talk window application with with Alphabetic keyboard layout")]
    public partial class TalkApplicationScannerAlphabetical : Form, IScannerPanel, ISupportsStatusBar, IScannerPreview
    {
        /// <summary>
        ...
        /// </summary>
        public TalkApplicationScannerAlphabetical()
        {
            InitializeComponent();
        ...
        /// <summary>
        /// Loads phrases from the abbreviations list.  These are abbreviations
        /// that are marked "Speak" as the mode.
        /// </summary>
        ...
        private class CommandHandler : RunCommandHandler
        {
            ...
            public override bool Execute(ref bool handled)
            {
                ...
                switch (Command)
                {
                    ...
                    case "ExitApp":
                        if (DialogUtils.ConfirmScanner("Quit Application?"))
                        {
                            Context.AppQuit = true;
