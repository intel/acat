...
namespace ACAT.Lib.Core.AnimationManagement
{
    ...
    /// </summary>
    public class AnimationManager2 : IDisposable
    {
        /// <summary>
        ...
        private UserControlConfigMapEntry _mapEntry;
        ...
        public void Start(String animationName = null)
        {
            ...
            */
            ...
            if (!CoreGlobals.AppPreferences.EnableAutoStartScan)
            {
                Log.Debug("CALIBTEST: AnimationManager2.Start.  Do AutoTransition");
                Transition();
            }
            else
            {
                Log.Debug("CALIBTEST: AnimationManager2.Start.  " + _firstAnimation.Name);
                Transition(_firstAnimation);
            }
        }
