...
namespace ACAT.Core.PanelManagement
{
    ...
    {
        private static readonly ILogger _logger = LogManager.GetLogger(typeof(ToastForm2).Name);
        ...
        public ToastForm2(String messageTitle, string messageText, int timeOut = 2000)
        {
            InitializeComponent();
            ShowInTaskbar = false;
            Load += ToastForm_Load;
