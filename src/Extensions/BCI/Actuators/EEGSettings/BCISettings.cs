...
namespace ACAT.Extensions.BCI.Actuators.EEG.EEGSettings
{
    ...
    public class BCISettings : PreferencesBase
    {
        ...
        */
        ...
        [Range(0.5f, 1f)]
        [UIHint("Slider")]
        public float Classifier_ConfidenceThreshold = 0.95f;
        ...
        [Range(0, 20)]
        [UIHint("Slider")]
        public float EyesClosed_AdaptiveThreshold = 5.5f;
        ...
        [Range(0.1f, 10)]
        [UIHint("Slider")]
        public float EyesClosed_AdaptiveThreshold_StandardDeviationMultiplier = 3;
