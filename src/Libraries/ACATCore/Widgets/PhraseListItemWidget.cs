...
namespace ACAT.Lib.Core.Widgets
{
    ...
    /// </summary>
    public class PhraseListItemWidget : ScannerButtonBase
    {
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        /// <param name="control">the inner .NET Control for the widget</param>
        public PhraseListItemWidget(Control control)
            : base(control)
        {
            if (button != null)
            {
            ...
            Colors = ThemeManager.Instance.ActiveTheme.Colors.GetColorScheme(ColorSchemes.PhraseSchemeName);
        }
        ...
        public override bool CanAddForAnimation()
        {
            ...
            Log.Debug("PhraseListItemWidget" + Name + ", AddForAnimation: " + AddForAnimation + ", Text: [" + text + "]");
