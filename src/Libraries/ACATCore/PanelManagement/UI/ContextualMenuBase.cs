////////////////////////////////////////////////////////////////////////////
// <copyright file="ContextMenuBase.cs" company="Intel Corporation">
//
...
namespace ACAT.Lib.Core.PanelManagement
{
    ...
    /// </summary>
    public partial class ContextualMenuBase : Form, IScannerPanel
    {
        /// <summary>
        ...
        public ContextualMenuBase(String panelClass, String panelTitle)
        {
            InitializeComponent();
...
#if abc
        class Dispatcher : RunCommandDispatcher
        {
            ...
            public override bool Dispatch(string command, ref bool handled)
            {
                ContextualMenuBase form = Scanner.Form as ContextualMenuBase;

                if (command[0] == '@')
                {
                    command = command.Substring(1);
                }
                Context.AppAgentMgr.RunCommand(command, form.startupCommandArg, ref handled);
                return true;
            }
        }
#endif
