...
namespace ACAT.Extensions.BCI.Sensors.OpenBCISensor
{
    ...
    /// </summary>
    [Serializable]
    public class OpenBCISettings : BCIActuatorSettings
    {
        /// <summary>
        ...
        */
        ...
        public OpenBCISettings Load(bool saveAfterLoad = true)
        {
            OpenBCISettings retVal = PreferencesBase.Load<OpenBCISettings>(SettingsFilePath, true, saveAfterLoad);
