...
namespace ACAT.Extensions.BCI.Actuators.EEG.EEGProcessing
{
    public class DecisionMaker
    {
        ...
        public DecisionMaker(string TrainedClassifiersFilePath)
        {
            ...
            maxNumberOfSequences = OpenBCISensorSettings.Settings.Classifier_MaxDecisionSequences;
            confidenceThreshold = OpenBCISensorSettings.Settings.Classifier_ConfidenceThreshold;
            _sequenceCount = 0;
