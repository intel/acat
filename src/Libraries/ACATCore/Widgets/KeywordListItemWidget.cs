...
namespace ACAT.Lib.Core.Widgets
{
    ...
    /// </summary>
    public class KeywordListItemWidget : ScannerButtonBase
    {
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        /// <param name="control">the inner .NET Control for the widget</param>
        public KeywordListItemWidget(Control control)
            : base(control)
        {
            if (button != null)
            {
        ...
        public override bool CanAddForAnimation()
        {
            ...
            Log.Debug("KeywordListItemWidget" + Name + ", AddForAnimation: " + AddForAnimation + ", Text: [" + text + "]");
