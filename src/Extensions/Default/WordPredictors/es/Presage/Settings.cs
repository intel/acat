...
{
    /// <summary>
    /// Preference settings for the Presage word predictor (Spanish)
    /// </summary>
    [Serializable]
    public class Settings : PresageSettingsBase
    {
        ...
        /// </summary>
        public String ARPAPredictorDatabaseFileName = "spanish.arpa";

        /// <summary>
        /// Name of the vocab file for the ARPA predictor
        /// </summary>
        public String ARPAPredictorVocabFileName = "spanish.vocab";
        ...
        /// </summary>
        [BoolDescriptor("Set this to true to use the ARPA database. To use the default NGRAM database, set it to false ", true)]
