...
namespace ACAT.Extensions.BCI.Common.EEGUtils
{
    public class FileWriter
    {
        ...
        //public static readonly T SensorSettings = new TSettings();
        ...
        public FileWriter()
        {
            ...
            //string dataDir = Path.Combine(UserManager.CurrentUserDir, "Actuators\\BCI\\" + SensorSettings.Settings.DAQ_OutputDirectory);
            string dataDir = Path.Combine(UserManager.CurrentUserDir, "Actuators\\BCI\\");
