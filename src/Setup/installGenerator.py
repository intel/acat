...
with open('NSIS_InstallerScript.nsi', 'a') as f:
    ...
    counter += 1
    f.write(f'  IfFileExists \"$INSTDIR\\Docs\\en\\ACAT BCI User Guide.pdf\" 0 NoShortcut{counter}\n')
    f.write(f'    SetOutPath \"$INSTDIR\"\n')
    f.write(f'    CreateShortCut \"$DESKTOP\\ACAT BCI User Guide.lnk\" \"$INSTDIR\\Docs\\en\\ACAT BCI User Guide.pdf\"\n')
    f.write(f'  NoShortcut{counter}:\n')
    ...
    f.write(f'  NoShortcut{counter}:\n')
    counter += 1
    f.write(f'  IfFileExists \"$DESKTOP\\ACAT BCI User Guide.lnk\" 0 NoShortcut{counter}\n')
    f.write(f'    Delete \"$DESKTOP\\ACAT BCI User Guide.lnk\"\n')
    f.write(f'  NoShortcut{counter}:\n')
