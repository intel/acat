...
namespace ACAT.Extension.AppAgents.WindowsExplorer
{
    /// <summary>
    ...
    public class WindowsExplorerAgentBase : GenericAppAgentBase
    {
        ...
        /// </summary>
        public bool autoSwitchScanners { get; set; } = false;
        ...
        {
            showPanel(this, new PanelRequestEventArgs(ContextualMenuName, StringResources.Explorer, monitorInfo));
        }
        ...
        public override void OnRunCommand(String command, object commandArg, ref bool handled)
        {
            ...
            switch (command)
            {
                ...
                case "NavigateMenu":
                    showMenu("WindowsExplorerNavigateMenu", StringResources.ExplorerNavigate);
                    break;

                case "FileOpsMenu":
                    showMenu("WindowsExplorerFileOpsMenu", StringResources.ExplorerFileOps);
                    break;

                case "ClipboardMenu":
                    showMenu("WindowsExplorerClipboardMenu", StringResources.ExplorerClipboard);
                    break;
        ...
        private void displayScanner(WindowActivityMonitorInfo monitorInfo, ref bool handled)
        {
            ...
            else// if (monitorInfo.IsNewWindow)
            {
                ...
                if (handled)
                {
                    showPanel(this, new PanelRequestEventArgs(panel, StringResources.Explorer, monitorInfo, true));
                    _scannerShown = true;
                }
            }
        }
        ...
        {
            var panelArg = new PanelRequestEventArgs(menuName, title, WindowActivityMonitor.CurrentWindowInfo())
            {
