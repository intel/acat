...
namespace ACAT.Extensions.FunctionalAgents.UI
{
    ...
    /// </summary>
    [ClassDescriptor("D946E1D6-5D67-40E6-B27F-F8D062DE5450",
                        "LaunchAppScanner",
                        "Launch Applications Scanner")]
    public partial class LaunchAppScanner : GenericScannerForm
    {
        /// <summary>
        ...
        private void close()
        {
            ...
            {
                if (DialogUtils.ConfirmScanner(PanelManager.Instance.GetCurrentForm(), StringResources.Close))
                {
