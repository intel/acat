...
namespace ACAT.Extensions.BCI.Sensors.GTecSensor
{
    ...
    public partial class UserControlBCISignalCheck : UserControlBCIBase
    {
        ...
        {
            _gTecBCI.BCIGtecActuatorSettings.SignalControl_RecheckNeeded = true;
            _gTecBCI.BCIGtecActuatorSettings.SignalQuality_PassedLastOverallQualityCheck = false;
            _gTecBCI.BCIGtecActuatorSettings.Save();
        }
        ...
        public void updateSignalStatus(double[,] latestUnfilteredData, double[,] latestFilteredData)
        {
            ...
            if (numGoodChannels >= _gTecBCI.BCIGtecActuatorSettings.SignalQuality_MinOverallGoodChannels && 
                numOkChannels <= _gTecBCI.BCIGtecActuatorSettings.SignalQuality_MaxOverallOKChannels​ &&
                numBadChannels <= _gTecBCI.BCIGtecActuatorSettings.SignalQuality_MaxOverallBadChannels​)
            {
                // All electrodes have valid values (none have status Error) and overall signal quality criteria met
                _gTecBCI.BCIGtecActuatorSettings.SignalQuality_PassedLastOverallQualityCheck = true;
            }
            else
            {
                _gTecBCI.BCIGtecActuatorSettings.SignalQuality_PassedLastOverallQualityCheck = false;
        ...
        public void initializeBCISignalCheck(DAQ_gTecBCI gtecbci, bool maxTimeHasElapsed, double maxTimeMins, double minElapsedPrevSignalQualityCheck, bool userPassedLastSignalQualityCheck)
        {
            ...
            _numChannels = _gTecBCI.BCIGtecActuatorSettings.DAQ_NumEEGChannels;
            _samplingRate = gTecBCI.sampleRate;
            _scaleIdx = _gTecBCI.BCIGtecActuatorSettings.SignalMonitor_ScaleIdx;
            ...
            new List<String> { _gTecBCI.BCIGtecActuatorSettings.SignalControl_RequiredChannel_Channel1_Name,_gTecBCI.BCIGtecActuatorSettings.SignalControl_RequiredChannel_Channel2_Name,
                _gTecBCI.BCIGtecActuatorSettings.SignalControl_RequiredChannel_Channel3_Name,_gTecBCI.BCIGtecActuatorSettings.SignalControl_RequiredChannel_Channel4_Name,
                _gTecBCI.BCIGtecActuatorSettings.SignalControl_RequiredChannel_Channel5_Name,_gTecBCI.BCIGtecActuatorSettings.SignalControl_RequiredChannel_Channel6_Name,
                _gTecBCI.BCIGtecActuatorSettings.SignalControl_RequiredChannel_Channel7_Name,_gTecBCI.BCIGtecActuatorSettings.SignalControl_RequiredChannel_Channel8_Name};
            ...
            for (int chIdx = 0; chIdx < _numChannels; chIdx++)
            {
                ...
                bool channelEnabled = _gTecBCI.BCIGtecActuatorSettings.GetClassifier_EnableChannel(chIdx);
        ...
        private void updateRailingTestResult(int chIdx, int railingResultPercentage, bool update_UI)
        {
            try
            {
                ...
                _gTecBCI.BCIGtecActuatorSettings.SignalQuality_LastRailingValues[chIdx] = railingResultPercentage;
                ...
                if (railingResultPercentage != int.MaxValue)
                {
                    ...
                    if (railingResultPercentage <= _gTecBCI.BCIGtecActuatorSettings.SignalQuality_RailingGoodMaxThreshold)
                        signalQualityStatus = SignalStatus.SIGNAL_OK;
                    //else if (railingResultPercentage <= _gTecBCI.BCIGtecActuatorSettings.SignalQuality_RailingOkMaxThreshold)
                        //signalQualityStatus = SignalStatus.SIGNAL_ACCEPTABLE;
                    else if (railingResultPercentage > _gTecBCI.BCIGtecActuatorSettings.SignalQuality_RailingGoodMaxThreshold && 
                        railingResultPercentage <= _gTecBCI.BCIGtecActuatorSettings.SignalQuality_RailingOkMaxThreshold​)
                        signalQualityStatus = SignalStatus.SIGNAL_ACCEPTABLE;
                    else if (railingResultPercentage > _gTecBCI.BCIGtecActuatorSettings.SignalQuality_RailingOkMaxThreshold)
