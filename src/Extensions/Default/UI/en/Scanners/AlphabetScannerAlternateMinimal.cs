////////////////////////////////////////////////////////////////////////////
// <copyright file="AlphabetScannerAlternateMinimal.cs" company="Intel Corporation">
//
...
{
    /// <summary>
    /// This form is the alphabet scanner without word prediction.
    /// This scanner displays the letters of the alphabet in
    /// an order that is optimized for typing  The most frequent
    /// letters in the English alphabet are towards the beginning
    /// of each row.  Use this when word prediction is not needed
    /// </summary>
    [DescriptorAttribute("32D2A726-43A9-40D7-81A3-86C6C9EF4530",
                        "AlphabetScannerAbcMinimal",
                        "Alphabet Scanner with Alternate layout")]
    public partial class AlphabetScannerAlternateMinimal : Form, IScannerPanel, IScannerPreview, ISupportsStatusBar
    {
        /// <summary>
