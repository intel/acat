...
{
    [ClassDescriptorAttribute("F8718D14-9904-4BF8-A095-446178BDC780",
        "KeyboardControl",
        "User Control keyboard BCI")]

    public partial class KeyboardYesNoUserControlBCI2 : UserControl, IUserControl
    {
        ...
        public KeyboardYesNoUserControlBCI2()
        {
            InitializeComponent();
        }
