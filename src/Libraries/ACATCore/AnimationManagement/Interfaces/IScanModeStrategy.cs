...
//
// Strategy interface for scan algorithms (auto, manual, step).
...
namespace ACAT.Core.AnimationManagement.Interfaces
{
    ...
    /// <summary>
    /// Encapsulates one scanning algorithm (auto, manual, step).
    ...
    {
        /// <summary>Display name registered in DI (e.g. "auto", "manual", "step").</summary>
        string Name { get; }

        /// <summary>
        /// Returns the index of the next widget to highlight.
        /// Called by AnimationSession on each timer tick (auto) or explicit advance (manual/step).
        /// </summary>
        ...
        /// Auto-scan strategies return currentIndex - 1 (or 0). Step may return -1.
        /// </summary>
