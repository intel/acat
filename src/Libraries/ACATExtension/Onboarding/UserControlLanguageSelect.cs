    ...
    public partial class UserControlLanguageSelect : UserControl, IOnboardingUserControl
    {
        ...
        public bool Initialize()
        {
            ...
            foreach (var actuator in actuators)
            {
                ...
                {
                    listBoxLanguages.Items.Add(actuatorSetting.Name);
                    _actuatorSettings.Add(actuatorSetting);
                }
            }

            listBoxLanguages.SelectedIndexChanged += ListBoxActuators_SelectedIndexChanged;
        ...
        {
            ActuatorSelected = getActuator(listBoxLanguages.SelectedIndex);
            var desc = _actuatorSettings[listBoxLanguages.SelectedIndex].Description;
            ...
            var file = _actuatorSettings[listBoxLanguages.SelectedIndex].ImageFileName;
