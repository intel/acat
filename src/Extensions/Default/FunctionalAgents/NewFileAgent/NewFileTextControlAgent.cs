////////////////////////////////////////////////////////////////////////////
// <copyright file="NewFileTextControlAgent.cs" company="Intel Corporation">
//
...
namespace ACAT.Extensions.Default.FunctionalAgents.NewFile
{
    ...
    /// auto-correct. Disallow expanding abbreviations
    /// </summary>
    public class NewFileTextControlAgent : EditTextControlAgent
    {
        /// <summary>
        ...
        public NewFileTextControlAgent(IntPtr handle, AutomationElement editControlElement, ref bool handled)
