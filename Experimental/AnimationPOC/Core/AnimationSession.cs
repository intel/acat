...
// AnimationSession.cs
//
// Core Phase A implementation of IAnimationSession.
// Replaces the AnimationPlayer + AnimationManager per-panel pattern.
// Designed per Issue #207 design spec §5.2 and §8.1 Step 4.
//
// Thread-safety model:
...
namespace ACAT.Experimental.AnimationPOC.Core
{
    ...
    /// Publishes AnimationStateChangedEvent, AnimationTransitionEvent, AnimationHighlightEvent
    /// to IEventBus on each state change and widget advance.
    ///
    ...
    public class AnimationSession : IAnimationSession
    {
        ...
        /// <param name="strategy">Scan mode strategy (AutoScanStrategy for Phase A).</param>
        ...
        public void Interrupt()
        {
            ...
            if (action == ScanInputAction.Select)
            {
                ...
                if (currentWidget != null)
                {
                    ...
                    // In Phase A, OnSelected PCode execution would be wired here.
                    // For the POC, we publish the event and log.
                }
        ...
        private void OnTimerElapsed(object sender, ElapsedEventArgs e)
        {
            ...
            if (sequenceEnded)
            {
                ...
                // In Phase B+, OnEnd PCode would execute here.
                // For the POC, we stop after sequence ends.
                lock (_sessionLock)
                {
